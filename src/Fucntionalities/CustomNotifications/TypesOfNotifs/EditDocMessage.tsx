...
//notification for changes in the medical documents
const EditDocMessage = ({ data, deleteNotif, index }: any) => {
    ...
    return <div className={`notification-item ${data.new ? "notification-new" : ""}`} id={`${index}`}>
        ...
        <div style={{ marginTop: '35px' }}>
            <div style={{ textAlign: 'center' }}>{data.text}{senderName}</div>
        </div>
    </div>
}

export default EditDocMessage